...
Route::middleware(['auth', 'role:user'])->prefix('/user')->group(function () {
    ...
    Route::post('form-dashboard', [PeminjamanController::class, 'formDasboard'])->name('user.form_peminjaman_dashboard');
...
Route::middleware(['auth', 'role:admin'])->prefix('/admin')->group(function () {
    ...
    //- - - - - - - - - Cetak Laporan- - - - - - - - - -
    //                [ Laporan PDF]
    Route::get('/laporan', [LaporanController::class, 'index'])->name('admin.index');
    ...
    //                [ Identitas Applikasi]
    Route::get('/identitas', [IdentitasController::class, 'indexIdentitas'])->name('admin.identitas');
